...
--CoronaSDK version 2012.868 was used for this template.
...
local mainGroup --Groups that we create
...
function scene:createScene( event )
	...
	local function startGame()
		...
		storyboard.gotoScene("game", "slideLeft", 600)
	end
	local playGame = display.newRect(0,0, 120, 60)
	playGame.x = _W*0.5; playGame.y = _H*0.84; playGame.alpha = 0.01
